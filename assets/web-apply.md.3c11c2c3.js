import{_ as e,o as t,c as o,a}from"./app.2aea72c0.js";const b=`{"title":"Customize .NET Core Apps with 'web +'","description":"","frontmatter":{"slug":"web-apply","title":"Customize .NET Core Apps with 'web +'"},"headers":[{"level":3,"title":"Usage","slug":"usage"},{"level":3,"title":"apply.md","slug":"apply-md"},{"level":3,"title":"Available Gists","slug":"available-gists"},{"level":3,"title":"Creating customized projects","slug":"creating-customized-projects"},{"level":3,"title":"Apply Gist Modifiers","slug":"apply-gist-modifiers"},{"level":3,"title":"Open for Gists!","slug":"open-for-gists"},{"level":3,"title":"Apply adhoc Gists","slug":"apply-adhoc-gists"}],"relativePath":"web-apply.md"}`,i={},r=a(`<p>Whilst we believe <a href="/web-new">x new</a> is a super simple way to create and maintain project templates, we&#39;ve also created an even simpler and lighter way to create projects - from gists!</p><p>We can use <code>x +</code> (read as &quot;apply gist&quot;) to create light-weight customized projects by applying multiple gists on top of each other. One of the major benefits of this approach is that it&#39;s not only limited at project creation time as it&#39;s also a great way to easily add &quot;layered functionality&quot; to existing projects.</p><p>We can see an example of this earlier with how we can use this to <a href="/templates-lite#updating-lite-project-dependencies">easily update dependencies in &quot;lite&quot; projects</a> which is just applying the <strong>vue-lite-lib</strong> and <strong>react-lite-lib</strong> gists to your existing &quot;lite&quot; projects:</p><pre><code>$ x +vue-lite-lib
...
</code></pre><p>Which as of this writing lists:</p><div class="language-"><pre><code>   1. init                 Empty .NET 6.0 ServiceStack App                                   to: .                            by @ServiceStack  [project]
...
</code></pre></div><p>Which can be chained together to search for all <code>project</code> and <code>sharp</code> gists we can use for <a href="https://sharpscript.net/docs/script-pages" target="_blank" rel="noopener noreferrer">Sharp Pages</a> projects:</p><pre><code>$ x + #project,sharp
...
Search:  web + #&lt;tag&gt;      Available tags: auth, config, db, example, lib, project, react, sharp, ui, vue
</code></pre></div><h3 id="creating-customized-projects" tabindex="-1">Creating customized projects <a class="header-anchor" href="#creating-customized-projects" aria-hidden="true">#</a></h3><p>From this list we can see that we can create an <strong>Empty .NET 6.0 ServiceStack App</strong> by starting in a new App Folder:</p><pre><code>$ mkdir ProjectName &amp;&amp; cd ProjectName
...
</code></pre><p>What&#39;s even better is that gists can be chained, so we can create a <strong>.NET 6.0 Bootstrap Sharp Pages App using PostgreSQL</strong> with:</p><pre><code>$ x +init+bootstrap-sharp+postgres
