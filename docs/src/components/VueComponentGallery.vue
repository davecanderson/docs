    ...
    <div class="pb-16">
        <div class="mx-auto max-w-2xl not-prose ">
            <NavList title="">
                ...
                <NavListItem title="AutoQuery Grid" href="/vue/gallery/autoquerygrid"
                ...
                <NavListItem title="Formats" href="/vue/gallery/formats" :iconSvg="Icons.Formats">
