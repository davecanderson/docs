...
---
<script setup>
import serveruis from '../src/components/ServerLoginUis.vue';
import clientuis from '../src/components/ClientLoginUis.vue';
import serverContactsUis from '../src/components/ServerContactsUis.vue';
import clientContactsUis from '../src/components/ClientContactsUis.vue';

import textDump from '../.vitepress/includes/textDump.md';
import requestPramMethods from '../.vitepress/includes/requestParamMethods.md';
import cleanUrls from '../.vitepress/includes/clean-urls.md';
</script>
...
<<< @/.vitepress/includes/textDump.md
...
<requestPramMethods></requestPramMethods>
...
<serverContactsUis></serverContactsUis>
...
<clientContactsUis></clientContactsUis>
...
.NET Core C# Templates:
   ...
   1. angular-lite-spa   .NET 6.0 Angular 4 Material Design Lite Webpack App
   2. angular-spa        .NET 6.0 Angular 12 CLI Bootstrap 5 App
   3. aurelia-spa        .NET 6.0 Aurelia CLI Bootstrap App
   4. aws-lambda         .NET 6.0 Website configured for AWS Lambda Containers
   5. empty              .NET 6.0 Empty Web Single Project Template
   6. grpc               .NET 6.0 gRPC Services
   7. mvc                .NET 6.0 MVC Website
   8. mvcauth            .NET 6.0 MVC Website integrated with ServiceStack Auth
   9. mvcidentity        .NET 6.0 MVC Website integrated with ServiceStack using MVC Identity Auth
  10. mvcidentityserver  .NET 6.0 MVC Website integrated with ServiceStack using IdentityServer4 Auth
  11. nextjs
  12. parcel             .NET 6.0 Parcel TypeScript App
  13. razor              .NET 6.0 Website with ServiceStack.Razor
  14. react-lite         .NET 6.0 simple + lite (npm-free) React SPA using TypeScript
  15. react-spa          .NET 6.0 React Create App CLI Bootstrap App
  16. script             .NET 6.0 #Script Pages Bootstrap Website
  17. selfhost           .NET 6.0 self-hosting Console App
  18. svelte-spa         .NET 6.0 Svelte v3 Rollup Bootstrap App
  19. vue-desktop        .NET 6.0 Chromium Vue Desktop App
  20. vue-lite           .NET 6.0 simple + lite (npm-free) Vue SPA using TypeScript
  21. vue-nuxt           .NET 6.0 Nuxt.js SPA App with Bootstrap
  22. vue-spa            .NET 6.0 Vue CLI Bootstrap App
  23. vue-vite           .NET 6.0 Vue Vite Tailwind App
  24. vuetify-nuxt       .NET 6.0 Nuxt.js SPA App with Material Vuetify
  25. vuetify-spa        .NET 6.0 Vue CLI App with Material Vuetify
  26. web                .NET 6.0 Empty Website
  27. worker-rabbitmq    .NET 6.0 Rabbit MQ Worker Service
  28. worker-redismq     .NET 6.0 Redis MQ Worker Service
  29. worker-servicebus  .NET 6.0 Azure Service Bus MQ Worker Service
  30. worker-sqs         .NET 6.0 AWS SQS MQ Worker Service
...
.NET Framework C# Templates:
   ...
   8. script-netfx              .NET Framework #Script Pages Bootstrap WebApp
   9. selfhost-netfx            .NET Framework self-hosting HttpListener Console App
...
<<< @/.vitepress/includes/gists/apply.md
...
[Community Auth Providers](/authentication-and-authorization#community-auth-providers) when a built-in solution doesn't exist
...
[Community Auth Providers](/authentication-and-authorization#community-auth-providers) instead.
...
> Note: Despite the new integration possibilities we're continuing to invest and enhance in [ServiceStack Auth](/authentication-and-authorization) 
