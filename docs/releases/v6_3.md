...
Where applicable, the GitHub Actions have been updated to automatically run on deployment before the new version of your application starts up. This is done in the `Run remote db migrations` step. 
