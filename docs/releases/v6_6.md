...
Which is still the best option to use in our [JAMStack TypeScript templates](https://vue-mjs.web-templates.io/templates-jamstack) where the DTOs integrate with the rest of your App's TypeScript code-base and its npm build tools takes care to transform it into its configured downlevel JS target bundles.
...
**[FileInput component](/vue/gallery/form-inputs#fileinput)** beautifies the browsers default HTML file Input, supporting both Single file uploads: 

```html
<FileInput id="profileUrl" label="Single File Upload" v-model="contact.profileUrl" />
```

<a href="/vue/gallery/form-inputs#fileinput"><img class="max-w-[516px]" src="/images/release-notes/v6.6/file-input-single.png"></a>
...
<a href="/vue/gallery/form-inputs#fileinput"><img class="max-w-[374px]" src="/images/release-notes/v6.6/file-input-multiple.png"></a>
...
**[TagInput component](/vue/gallery/form-inputs#taginput)** provides a user friendly control for managing a free-form `List<string>` tags or symbols
...
<a href="/vue/gallery/form-inputs#taginput"><img class="max-w-[778px]" src="/images/release-notes/v6.6/taginput-examples.png"></a>

### Autocomplete

**[Autocomplete component](/vue/gallery/form-inputs#autocomplete)** provides a user friendly Input for being able to search and quickly select items
with support for partial items view and infinite scrolling.

<a href="/vue/gallery/form-inputs#autocomplete"><img class="max-w-[571px]" src="/images/release-notes/v6.6/autocomplete-examples.png"></a>
...
Effectively it looks to allow any serializable models and DTOs it can find by looking at all heuristics available.
