...
```
<div class="text-center"><Hello id="hello" name="Vue 3" class="text-2xl py-4" /></div>
...
<div class="text-center"><Counter id="counter" class="text-2xl py-4 select-none cursor-pointer" /></div>
...
<div class="text-center not-prose"><Plugin id="plugin" class="text-center text-2xl py-4" /></div>
...
<VueComponentGallery id="component-gallery" />

It's our cornerstone library for enabling a highly productive Vue.js development model across our [Vue Tailwind Project templates](/templates-vue) 
which we'll be continuing to invest in future to unlock even greater productivity benefits in all Vue.js Tailwind Apps.
