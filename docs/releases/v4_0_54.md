...
![](https://raw.githubusercontent.com/ServiceStack/Admin/master/img/query-default-values.png)
...
Which requires [AutoQuery](/autoquery), if not already registered:
...
[Northwind AutoQuery Services](https://northwind.netcore.io/ss_admin/autoquery/QueryCustomers) below:
...
[![](https://raw.githubusercontent.com/ServiceStack/Admin/master/img/unannotated-autoquery-services.png)](https://northwind.netcore.io/ss_admin/autoquery/QueryCustomers)
...
with the `[AutoQueryViewer]` attribute, as seen in GitHub QueryRepos:
...
![](https://raw.githubusercontent.com/ServiceStack/Admin/master/img/query-default-values-markup.png)
...
A useful [JSON customization](/customize-json-responses#customize-json-responses-on-the-fly)
...
which we hope spurs the creation of even richer community [Plugins](/plugins)!
...
[chat.netcore.io](http://chat.netcore.io/) back-end where it's able to communicate with existing 
